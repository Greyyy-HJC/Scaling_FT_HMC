...
# rand_seed_ls = [1331, 1984, 1999, 2008, 2017, 2025]
...
gamma_L32_b6_ratio_ls = [gamma_ratio_base_L32_b6, gamma_ratio_base32_L32_b6, gamma_ratio_attn_L32_b6, gamma_ratio_resn_L32_b6, gamma_ratio_tanh_L32_b6, gamma_ratio_combined64_L32_b6, gamma_ratio_combined_L32_b6]

deltaQ_L32_b6_ratio_ls = [deltaQ_ratio_base_L32_b6, deltaQ_ratio_base32_L32_b6, deltaQ_ratio_attn_L32_b6, deltaQ_ratio_resn_L32_b6, deltaQ_ratio_tanh_L32_b6, deltaQ_ratio_combined64_L32_b6, deltaQ_ratio_combined_L32_b6]

gamma_L64_b6_ratio_ls = [gamma_ratio_base_L64_b6, gamma_ratio_base32_L64_b6, gamma_ratio_attn_L64_b6, gamma_ratio_resn_L64_b6, gamma_ratio_tanh_L64_b6, gamma_ratio_combined64_L64_b6, gamma_ratio_combined_L64_b6]

deltaQ_L64_b6_ratio_ls = [deltaQ_ratio_base_L64_b6, deltaQ_ratio_base32_L64_b6, deltaQ_ratio_attn_L64_b6, deltaQ_ratio_resn_L64_b6, deltaQ_ratio_tanh_L64_b6, deltaQ_ratio_combined64_L64_b6, deltaQ_ratio_combined_L64_b6]
...
ax.errorbar(np.arange(len(gamma_L32_b5_ratio_ls))-0.1, [gv.mean(gamma_ratio) for gamma_ratio in gamma_L32_b5_ratio_ls], [gv.sdev(gamma_ratio) for gamma_ratio in gamma_L32_b5_ratio_ls], label="$\\beta=5$, $V=32^2$", marker="x", **errorb)
...
ax.set_xticklabels(['Base', 'Base32', 'Attn', 'Resn', 'Tanh', 'Comb', 'Comb32'], fontsize=18)
...
ax.errorbar(np.arange(len(deltaQ_L32_b5_ratio_ls))-0.1, [gv.mean(deltaQ_ratio) for deltaQ_ratio in deltaQ_L32_b5_ratio_ls], [gv.sdev(deltaQ_ratio) for deltaQ_ratio in deltaQ_L32_b5_ratio_ls], label="$\\beta=5$, $V=32^2$", **errorb_circle)
