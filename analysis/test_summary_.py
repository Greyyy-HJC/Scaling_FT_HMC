...
fthmc_2plaq_weight_L32_b6_topo_1029 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1029.csv')
fthmc_2plaq_weight_L32_b6_topo_1107 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1107.csv')
fthmc_2plaq_weight_L32_b6_topo_1331 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1331.csv')
fthmc_2plaq_weight_L32_b6_topo_1984 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1984.csv')
fthmc_2plaq_weight_L32_b6_topo_1999 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1999.csv')
fthmc_2plaq_weight_L32_b6_topo_2008 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_2008.csv')
fthmc_2plaq_weight_L32_b6_topo_2017 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_2017.csv')
fthmc_2plaq_weight_L32_b6_topo_2025 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L32_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_2025.csv')
...
fthmc_2plaq_weight_L32_b6_auto_1029 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_1029, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L32_b6_auto_1107 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_1107, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L32_b6_auto_1331 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_1331, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L32_b6_auto_1984 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_1984, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L32_b6_auto_1999 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_1999, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L32_b6_auto_2008 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_2008, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L32_b6_auto_2017 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_2017, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L32_b6_auto_2025 = auto_from_chi(fthmc_2plaq_weight_L32_b6_topo_2025, max_lag=max_lag, beta=beta, volume=volume)


gamma_hmc = 1 / (1 - hmc_L32_b6_auto[16])
gamma_fthmc_1029 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_1029[16])
gamma_fthmc_1107 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_1107[16])
gamma_fthmc_1331 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_1331[16])
gamma_fthmc_1984 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_1984[16])
gamma_fthmc_1999 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_1999[16])
gamma_fthmc_2008 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_2008[16])
gamma_fthmc_2017 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_2017[16])
gamma_fthmc_2025 = 1 / (1 - fthmc_2plaq_weight_L32_b6_auto_2025[16])
...
plaq2_weight_L32_b6_gamma_ratio = jk_ls_avg(gamma_ratio_L32_b6_jk)

print("\n>>> 2plaq_weight b6 L32 gamma ratio")
print(f"mean(16) for 2plaq_weight b6 L32: {gv.mean(plaq2_weight_L32_b6_gamma_ratio)}")

deltaQ_hmc = [ abs(hmc_L32_b6_topo[i] - hmc_L32_b6_topo[i-1]) for i in range(1, len(hmc_L32_b6_topo))]
deltaQ_fthmc_1029 = [ abs(fthmc_2plaq_weight_L32_b6_topo_1029[i] - fthmc_2plaq_weight_L32_b6_topo_1029[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_1029))]
deltaQ_fthmc_1107 = [ abs(fthmc_2plaq_weight_L32_b6_topo_1107[i] - fthmc_2plaq_weight_L32_b6_topo_1107[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_1107))]
deltaQ_fthmc_1331 = [ abs(fthmc_2plaq_weight_L32_b6_topo_1331[i] - fthmc_2plaq_weight_L32_b6_topo_1331[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_1331))]
deltaQ_fthmc_1984 = [ abs(fthmc_2plaq_weight_L32_b6_topo_1984[i] - fthmc_2plaq_weight_L32_b6_topo_1984[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_1984))]
deltaQ_fthmc_1999 = [ abs(fthmc_2plaq_weight_L32_b6_topo_1999[i] - fthmc_2plaq_weight_L32_b6_topo_1999[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_1999))]
deltaQ_fthmc_2008 = [ abs(fthmc_2plaq_weight_L32_b6_topo_2008[i] - fthmc_2plaq_weight_L32_b6_topo_2008[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_2008))]
deltaQ_fthmc_2017 = [ abs(fthmc_2plaq_weight_L32_b6_topo_2017[i] - fthmc_2plaq_weight_L32_b6_topo_2017[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_2017))]
deltaQ_fthmc_2025 = [ abs(fthmc_2plaq_weight_L32_b6_topo_2025[i] - fthmc_2plaq_weight_L32_b6_topo_2025[i-1]) for i in range(1, len(fthmc_2plaq_weight_L32_b6_topo_2025))]

deltaQ_hmc_L32_b6_mean = np.mean(deltaQ_hmc)
deltaQ_fthmc_L32_b6_jk = jackknife([np.mean(deltaQ_fthmc_1029), np.mean(deltaQ_fthmc_1107), np.mean(deltaQ_fthmc_1331), np.mean(deltaQ_fthmc_1984), np.mean(deltaQ_fthmc_1999), np.mean(deltaQ_fthmc_2008), np.mean(deltaQ_fthmc_2017), np.mean(deltaQ_fthmc_2025)])

plaq2_weight_L32_b6_deltaQ_ratio = jk_ls_avg(deltaQ_fthmc_L32_b6_jk) / deltaQ_hmc_L32_b6_mean

print("\n>>> 2plaq_weight b6 L32 deltaQ ratio")
print(f"mean(deltaQ) ratio for 2plaq_weight b6 L32: {gv.mean(plaq2_weight_L32_b6_deltaQ_ratio)}")
print(f"std(deltaQ) ratio for 2plaq_weight b6 L32: {gv.sdev(plaq2_weight_L32_b6_deltaQ_ratio)}")
...
fthmc_2plaq_weight_L64_b6_topo_1029 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1029.csv')
fthmc_2plaq_weight_L64_b6_topo_1107 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1107.csv')
fthmc_2plaq_weight_L64_b6_topo_1331 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1331.csv')
fthmc_2plaq_weight_L64_b6_topo_1984 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1984.csv')
fthmc_2plaq_weight_L64_b6_topo_1999 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_1999.csv')
fthmc_2plaq_weight_L64_b6_topo_2008 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_2008.csv')
fthmc_2plaq_weight_L64_b6_topo_2017 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_2017.csv')
fthmc_2plaq_weight_L64_b6_topo_2025 = np.loadtxt('/eagle/fthmc/run/Scaling_FT_HMC/2plaq_weight_evaluation/dumps/topo_fthmc_L64_beta6.0_nsteps10_2plaq_weight_train_b3.0_L32_2025.csv')
...
fthmc_2plaq_weight_L64_b6_auto_1029 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_1029, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L64_b6_auto_1107 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_1107, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L64_b6_auto_1331 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_1331, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L64_b6_auto_1984 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_1984, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L64_b6_auto_1999 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_1999, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L64_b6_auto_2008 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_2008, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L64_b6_auto_2017 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_2017, max_lag=max_lag, beta=beta, volume=volume)
fthmc_2plaq_weight_L64_b6_auto_2025 = auto_from_chi(fthmc_2plaq_weight_L64_b6_topo_2025, max_lag=max_lag, beta=beta, volume=volume)

idx = 16

gamma_hmc = 1 / (1 - hmc_L64_b6_auto[idx])

gamma_fthmc_1029 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_1029[idx])
gamma_fthmc_1107 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_1107[idx])
gamma_fthmc_1331 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_1331[idx])
gamma_fthmc_1984 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_1984[idx])
gamma_fthmc_1999 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_1999[idx])
gamma_fthmc_2008 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_2008[idx])
gamma_fthmc_2017 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_2017[idx])
gamma_fthmc_2025 = 1 / (1 - fthmc_2plaq_weight_L64_b6_auto_2025[idx])
...
plaq2_weight_L64_b6_gamma_ratio = jk_ls_avg(gamma_ratio_L64_b6_jk)

print("\n>>> 2plaq_weight b6 L64 gamma ratio")
print(f"mean({idx}) for 2plaq_weight b6 L64: {gv.mean(plaq2_weight_L64_b6_gamma_ratio)}")
print(f"std({idx}) for 2plaq_weight b6 L64: {gv.sdev(plaq2_weight_L64_b6_gamma_ratio)}")

deltaQ_hmc = [ abs(hmc_L64_b6_topo[i] - hmc_L64_b6_topo[i-1]) for i in range(1, len(hmc_L64_b6_topo))]
deltaQ_fthmc_1029 = [ abs(fthmc_2plaq_weight_L64_b6_topo_1029[i] - fthmc_2plaq_weight_L64_b6_topo_1029[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_1029))]
deltaQ_fthmc_1107 = [ abs(fthmc_2plaq_weight_L64_b6_topo_1107[i] - fthmc_2plaq_weight_L64_b6_topo_1107[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_1107))]
deltaQ_fthmc_1331 = [ abs(fthmc_2plaq_weight_L64_b6_topo_1331[i] - fthmc_2plaq_weight_L64_b6_topo_1331[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_1331))]
deltaQ_fthmc_1984 = [ abs(fthmc_2plaq_weight_L64_b6_topo_1984[i] - fthmc_2plaq_weight_L64_b6_topo_1984[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_1984))]
deltaQ_fthmc_1999 = [ abs(fthmc_2plaq_weight_L64_b6_topo_1999[i] - fthmc_2plaq_weight_L64_b6_topo_1999[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_1999))]
deltaQ_fthmc_2008 = [ abs(fthmc_2plaq_weight_L64_b6_topo_2008[i] - fthmc_2plaq_weight_L64_b6_topo_2008[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_2008))]
deltaQ_fthmc_2017 = [ abs(fthmc_2plaq_weight_L64_b6_topo_2017[i] - fthmc_2plaq_weight_L64_b6_topo_2017[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_2017))]
deltaQ_fthmc_2025 = [ abs(fthmc_2plaq_weight_L64_b6_topo_2025[i] - fthmc_2plaq_weight_L64_b6_topo_2025[i-1]) for i in range(1, len(fthmc_2plaq_weight_L64_b6_topo_2025))]

deltaQ_hmc_L64_b6_mean = np.mean(deltaQ_hmc)
deltaQ_fthmc_L64_b6_jk = jackknife([np.mean(deltaQ_fthmc_1029), np.mean(deltaQ_fthmc_1107), np.mean(deltaQ_fthmc_1331), np.mean(deltaQ_fthmc_1984), np.mean(deltaQ_fthmc_1999), np.mean(deltaQ_fthmc_2008), np.mean(deltaQ_fthmc_2017), np.mean(deltaQ_fthmc_2025)])

plaq2_weight_L64_b6_deltaQ_ratio = jk_ls_avg(deltaQ_fthmc_L64_b6_jk) / deltaQ_hmc_L64_b6_mean

print("\n>>> 2plaq_weight b6 L64 deltaQ ratio")
print(f"mean(deltaQ) ratio for 2plaq_weight b6 L64: {gv.mean(plaq2_weight_L64_b6_deltaQ_ratio)}")
print(f"std(deltaQ) ratio for 2plaq_weight b6 L64: {gv.sdev(plaq2_weight_L64_b6_deltaQ_ratio)}")
...
gamma_L32_b6_ratio_ls = [base_L32_b6_gamma_ratio, tanh_L32_b6_gamma_ratio, arctan_L32_b6_gamma_ratio, allp_L32_b6_gamma_ratio, allr_L32_b6_gamma_ratio, plaq2_L32_b6_gamma_ratio, plaq2_weight_L32_b6_gamma_ratio]

deltaQ_L32_b6_ratio_ls = [base_L32_b6_deltaQ_ratio, tanh_L32_b6_deltaQ_ratio, arctan_L32_b6_deltaQ_ratio, allp_L32_b6_deltaQ_ratio, allr_L32_b6_deltaQ_ratio, plaq2_L32_b6_deltaQ_ratio, plaq2_weight_L32_b6_deltaQ_ratio]

gamma_L64_b6_ratio_ls = [base_L64_b6_gamma_ratio, tanh_L64_b6_gamma_ratio, arctan_L64_b6_gamma_ratio, allp_L64_b6_gamma_ratio, allr_L64_b6_gamma_ratio, plaq2_L64_b6_gamma_ratio, plaq2_weight_L64_b6_gamma_ratio]

deltaQ_L64_b6_ratio_ls = [base_L64_b6_deltaQ_ratio, tanh_L64_b6_deltaQ_ratio, arctan_L64_b6_deltaQ_ratio, allp_L64_b6_deltaQ_ratio, allr_L64_b6_deltaQ_ratio, plaq2_L64_b6_deltaQ_ratio, plaq2_weight_L64_b6_deltaQ_ratio]
...
ax2.set_xticklabels(['Base', 'Tanh', 'arctan', 'allp', 'allr', 'plaq2', 'plaq2_wt'], fontsize=19)
