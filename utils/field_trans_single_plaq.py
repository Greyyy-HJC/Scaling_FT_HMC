...
class FieldTransformation:
    ...
    def compute_K0_K1(self, theta, index, plaq, rect):
        ...
        # Use joint model to generate K0
        K0 = self.models[index](plaq_features, rect_features)
    ...
    def ft_phase(self, theta, index):
        ...
        sin_plaq_stack = torch.stack([sin_plaq_dir0_1, sin_plaq_dir1_1], dim=1) # [batch_size, 2, L, L]
        
        # OPTIMIZATION: Pass cached plaq and rect to avoid recomputation
        K0 = self.compute_K0_K1(theta, index, plaq, rect) # [batch_size, 2, L, L]
    ...
    def compute_jac_logdet(self, theta):
        ...
        for index in range(self.n_subsets):
            ...
            cos_plaq_stack = -torch.cos(plaq_angles)  # [batch_size, 2, L, L]
            
            del plaq_angles
            
            # Get K0, K1 coefficients using cached plaq and rect
            K0 = self.compute_K0_K1(theta_curr, index, plaq, rect) # [batch_size, 2, L, L]
            ...
            del plaq_jac_shift, field_mask, plaq, rect
