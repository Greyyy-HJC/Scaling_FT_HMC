...
def auto_from_chi(topo, max_lag, beta, volume):
    ...
    topo = topo - np.mean(topo)  # ensure zero-mean
...
def hmc_summary(beta, max_lag, volume, therm_plaq_ls, plaq_ls, topological_charges, hamiltonians, therm_acceptance_rate, acceptance_rate):
    ...
    hmc_fig = plot_results(beta, therm_plaq_ls, plaq_ls, topological_charges, hamiltonians, autocor_from_chi)
...
def plot_results(beta, therm_plaq_ls, plaq_ls, topological_charges, hamiltonians, autocorrelations):
    ...
    plt.title(f'Autocorrelation', fontsize=fontsize)
